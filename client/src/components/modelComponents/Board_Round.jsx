...
Command: npx gltfjsx@6.5.3 public/round_cuttingboard_colored.glb -o src/components/modelComponents/Board_Round.jsx -r public 
*/
...
export function Board_Round({dUrl, dPos, dRot, dScale, imageArray, imageInfoArray, selectedDesign}) {
  const { nodes, materials } = useGLTF('/round_cuttingboard_colored.glb')
...
useGLTF.preload('/round_cuttingboard_colored.glb')
